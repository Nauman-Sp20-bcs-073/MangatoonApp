...
export default function NovelDetailPage(){
    ...
    const [novels, setNovels] = useState(state)
...
// fetches comments
 ...
 <CardContent>
        ...
        <Box className="NovelBox">
            ...
            <Box className="generalText">NovelToon got authorization from "{state.author}" to publish this work, the content is the author's own point of view, and does not represent the stand of NovelToon.</Box>
             ...
             <div className="rating">  
              ...
              <Button className="ReadButton" variant="contained" style={{marginLeft:"5%", marginTop:"5%"}}> Read </Button>
            </Box>
    ...
    <Box>  
    <div>
    <Button style={{marginTop:"2%",color:"black"}} sx={{"&:hover":{backgroundColor:'rgb(100, 100, 249)'}}} variant="outlined" onClick={(event)=> {(loginStatus() === true) ? handleClickOpen() : alert("You must be Logged in to perform this Action")}}>Write a Review</Button>
